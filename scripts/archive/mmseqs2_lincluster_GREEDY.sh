...
#SBATCH --job-name=mmseqs2_GREEDY       # Job name    (default: sbatch)
#SBATCH --output=mmseqs2_GREEDY-%j.out  # Output file (default: slurm-%j.out)
#SBATCH --error=mmseqs2_GREEDY-%j.err   # Error file  (default: slurm-%j.out)
...
mkdir -p ../../results/mmseqs2/Greedy_clust/
mmseqs createdb DB.fa ../../results/mmseqs2/Greedy_clust/DB
rm -r DB.fa
...
#         --cluster-mode 0    : BLASTclust
#          
cd ../../results/mmseqs2/Greedy_clust
mkdir tmp
