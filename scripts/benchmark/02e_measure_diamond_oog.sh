...
# 
#   - 06a: OMA analysis on OMA groups (also called Orthologous Groups)
#   - 06b: OrthoFinder MMseqs2 on HOG (Hierarchical Orthologous Groups)
#   - 06c: OrthoFinder MMseqs2 on OOG (1:1 Orthologs)
#   - 06d: OrthoFinder Diamond on HOG
#   - 06e: OrthoFinder Diamond on OOG
# ------------------------------------------------------------------------------
...
#SBATCH --mem-per-cpu=60GB              # Memory per CPU (in MB)
...
Rscript src/benchmark/measure_orthomap_cluster.R \
        data/configuration/05e_config_diamond_oog.yaml \
        diamond_oog.csv